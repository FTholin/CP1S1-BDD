...
> ⚠️ Chaque ligne est soit une **entrée** (remboursement envoyé), soit une **sortie** (dépense avancée). L'autre colonne est toujours `NULL`. Certains motifs sont aussi `NULL`.
